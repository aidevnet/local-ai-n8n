...
**Self-hosted AI Starter Kit** is an open-source Docker Compose template that
quickly bootstraps a fully featured Local AI and Low Code development environment. 

This is Adrian's version with a couple of improvements! Also, the local RAG AI Agent workflow 
will be automatically in your n8n instance if you use this setup instead of the base one provided by n8n!
...
```
git clone https://github.com/aidevnet/local-ai-n8n.git
...
2. Open the included workflow:
   <http://localhost:5678/workflow/CHYJnA5gC9gyqyLJ>
